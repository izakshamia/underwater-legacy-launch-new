      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-gold mx-auto mb-6 reveal"></div>
            <p className="text-white/80 max-w-2xl mx-auto reveal">
              7Founders brings together the elite community of עמותת הצוללנים—ex-submariners who have transformed their deep-sea expertise into entrepreneurial excellence. This launch event marks the beginning of a new chapter in our collective journey.
            </p>
          </div>
