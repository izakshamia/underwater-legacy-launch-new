        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/80 max-w-2xl mx-auto reveal">
              7Founder brings together the elite community of עמותת הצוללנים—ex-submariners who have transformed their deep-sea expertise into entrepreneurial excellence. This launch event marks the beginning of a new chapter in our collective journey.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8">
                ...
                <p className="text-white/80 mb-4">
                  The 7Founder represents the next evolution of our community—a structured forum where the unique skills, discipline, and perspective forged beneath the waves can be channeled into entrepreneurial success.
                </p>
